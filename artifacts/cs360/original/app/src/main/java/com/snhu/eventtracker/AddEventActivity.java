...
public class AddEventActivity extends AppCompatActivity {
    ...
    private Event findEventById(long eventId) {
        List<Event> userEvents = eventRepository.getEventsForUser(userId);
    ...
    private void onSaveClicked() {
        ...
        if (title.isEmpty()) {
            titleLayout.setError(getString(R.string.hint_event_title));
            return;
        }
        ...
        Event event = new Event(editingEventId, title, displayDate, displayTime, notes, smsReminder);
